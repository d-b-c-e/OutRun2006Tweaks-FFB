...
- Steering device assignment checks all retained primary buttons against other
  roles on that device before saving, including the first Steering assignment.
